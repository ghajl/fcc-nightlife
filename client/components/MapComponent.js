    ...
    >
      {props.markers 
        ? props.markers.map((marker, index) => {
            ...
            const lat = isNaN(marker.location.lat) ?  marker.location.lat() : marker.location.lat;
            const lng = isNaN(marker.location.lng) ?  marker.location.lng() : marker.location.lng;
